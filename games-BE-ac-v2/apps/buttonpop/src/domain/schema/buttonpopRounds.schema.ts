...
@Schema({ timestamps: true, autoIndex: false, collection: 'buttonpop_rounds' })
export class ButtonPopRound {
  @Prop({ required: true })
  roundId: string;
...
export const ButtonPopRoundSchema = SchemaFactory.createForClass(ButtonPopRound);

export type ButtonPopRoundModel = Model<ButtonPopRound>;
